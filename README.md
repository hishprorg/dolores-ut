...
// File generated by the post@hishprorg/dolores-ut plugin. Please do not modify it !!!
import { injectStyles } from '@hishprorg/dolores-ut';
...
## Installation
```bash
npm i postcss post@hishprorg/dolores-ut --save-dev
```
...
```javascript
// postcss.config.js
const { postcssEsModules }  = require('post@hishprorg/dolores-ut');
module.exports = (ctx) => ({
    plugins: [
        postcssEsModules({
            // options
...
You can find more examples [here](https://majo44.github.io/post@hishprorg/dolores-ut/#/examples/).
...
const { collectStyles } = require('@hishprorg/dolores-ut');
...
The full working example you will find  [here](https://majo44.github.io/post@hishprorg/dolores-ut/#/examples/react-ssr-webpack-typescript/).
...
## Next steps
For more information please go to the [api reference](https://majo44.github.io/post@hishprorg/dolores-ut/#/api/) documentation
or to the [examples](https://majo44.github.io/post@hishprorg/dolores-ut/#/examples/) section.

## Need a help ?
If you have any problems, issues, ect. please use [github discussions](https://github.com/hishprorg/dolores-ut/discussions). 
